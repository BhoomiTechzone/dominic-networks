                ...
                <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", p:"2rem" }}>
                    ...
                    <Box >
                        <Typography color="" textAlign="left" fontSize="18px" lineHeight="35px"  >
                            Thank you for choosing ANONET Broadband, your premier destination for reliable and lightning-fast broadband services. In today's digital landscape, we understand the paramount importance of staying connected.
                            Our internet services are meticulously crafted to cater to your specific needs, whether you're a home user seeking high-speed streaming and gaming experiences or a business professional reliant on flawless online operations. With ANONET Broadband, you can count on uninterrupted connectivity, blazing speeds, and limitless data, all made possible by our cutting-edge technology and state-of-the-art infrastructure.
